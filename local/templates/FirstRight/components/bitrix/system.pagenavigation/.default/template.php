...
<div class="catalog__pagination">
    <section class="pagination">
        <div class="pagination__box section">
            <div class="pagination__controls">
                <?if ($arResult["NavPageNomer"] > 1):?>
                <?if($arResult["bSavePage"]):?>
                <a class="pagination__control pagination__control_prev" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><?echo GetMessage("round_nav_back")?></a>
                ...
                <?if ($arResult["NavPageNomer"] > 2):?>
                    ...
                    <ol class="pagination__list">
                        ...
                        <ol class="pagination__list">
                            ...
                            <a class="pagination__control pagination__control_next" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><?echo GetMessage("round_nav_forward")?></a>
                            <?else:?>
                            <?if($arResult["NavPageCount"] > 1):?>
