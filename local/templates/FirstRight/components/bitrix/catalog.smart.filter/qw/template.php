...
<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
    ...
    if(false) {
        foreach ($arResult["ITEMS"] as $key => $arItem)//prices
        {
            ...
            if (isset($arItem["PRICE"])):
                ...
                ?>
                <div class="catalog-filter__group" data-role="bx_filter_block">
                    <span class="bx-filter-container-modef"></span>
                    <div class="catalog-filter__group-header">
                        <div class="catalog-filter__group-name">Цена</div>
                    </div>
                    <div class="catalog-filter__group-main">
                        <div class="catalog-filter__prices">
                            <div class="catalog-filter__price-box">
                                <input
                                        type="text"
                                        placeholder="<?
                                        echo $arItem["VALUES"]["MIN"]["FILTERED_VALUE"] ?>"
                                        name="<?
                                        ...
                                        class="catalog-filter__price catalog-filter__price_min"/>
                            </div>
                            <div class="catalog-filter__price-separator"></div>
                            <div class="catalog-filter__price-box">
                                <input
                                        type="text"
                                        placeholder="<?
                                        echo $arItem["VALUES"]["MAX"]["FILTERED_VALUE"] ?>"
                                        name="<?
                                        ...
                                        size="5"
                                        onkeyup="smartFilter.keyup(this)"
                                        class="catalog-filter__price catalog-filter__price_max"/>
                            </div>
                        </div>
    ...
    {
        if(
            empty($arItem["VALUES"]) || count($arItem["VALUES"]) < 2  || isset($arItem["PRICE"])
        )
            continue;
        ...
        if (
            ...
            continue;
        ?>
        <div class="catalog-filter__group bx-filter-parameters-box bx-active">
            <span class="bx-filter-container-modef"></span>
            <div class="catalog-filter__group-header">
                <div class="catalog-filter__group-name"><?=$arItem["NAME"]?></div>
            </div>
            <div class="bx-filter-parameters-box-container catalog-filter__group-main" data-role="bx_filter_block">
            <?
            ...
            switch ($arItem["DISPLAY_TYPE"])
            {
                    ...
                    <div class="col-xs-6 bx-filter-parameters-box-container-block bx-left">
                        <div class="bx-filter-input-container">
                            <input
                                ...
                                value="<?echo $arItem["VALUES"]["MIN"]["HTML_VALUE"] ? $arItem["VALUES"]["MIN"]["HTML_VALUE"] : htmlspecialcharsbx($arItem["VALUES"]["MIN"]["VALUE"])?>"
                                size="5"
                                onkeyup="smartFilter.keyup(this)"
                            />
                        </div>
                    ...
                    <div class="col-xs-6 bx-filter-parameters-box-container-block bx-right">
                        <div class="bx-filter-input-container">
                            <input
                                ...
                                value="<?echo $arItem["VALUES"]["MAX"]["HTML_VALUE"] ? $arItem["VALUES"]["MAX"]["HTML_VALUE"] : htmlspecialcharsbx($arItem["VALUES"]["MAX"]["VALUE"])?>"
                                size="5"
                                onkeyup="smartFilter.keyup(this)"
                            />
                        </div>
                ...
                default://CHECKBOXES
                    ?>
                    <?foreach($arItem["VALUES"] as $val => $ar):?>
                        <div class="catalog-filter__checkbox <? echo $ar["DISABLED"] ? 'filter-property_disabled': '' ?>">
                            <div class="checkbox">
                                <label class="checkbox__wrap">
                                    <input
                                        ...
                                        <? echo $ar["CHECKED"]? 'checked="checked"': '' ?>
                                            onclick="smartFilter.click(this)"
                                    />
                                    <span class="checkbox__content"><?=$ar["VALUE"];?></span>
                                </label>
                            </div>
                        </div>
                    <?endforeach;?>
    ...
    <div class="catalog-filter__group">
        <input
                class="btn btn-themes h-content"
                type="submit"
                id="set_filter"
                name="set_filter"
