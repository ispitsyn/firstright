...
<div class="catalog__cards">
    <section class="grid-cards">
        <div class="grid-cards__box section">
            <div class="h-content">Каталог товаров</div>
                ...
                <?if (count($arResult['ITEMS'])) {
                    ...
                    foreach ($arResult['ITEMS'] as $item) {
                        ...
                        <li class="grid-cards__item">
                            <a href="<?=$item['DETAIL_PAGE_URL']?>" class="product-card">
                                <div class="product-card__box" itemscope="itemscope" itemtype="http://schema.org/Product">
                                    <div class="product-card__view"><img class="product-card__img" itemprop="image" src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="" role="presentation"/>
                                    </div>
                                    <div class="product-card__info">
                                        <h3 class="product-card__name"><span itemprop="brand">Apple </span><span itemprop="name"><?=$item['NAME']?></span>
                                        </h3>
                                        ...
                                        <div class="product-card__price-box" itemprop="offers" itemscope="itemscope" itemtype="http://schema.org/Offer">
                                            <div class="product-card__price b-price">
                                                ...
                                                <span itemprop="price"><?=number_format($item['PRICES']['BASE']['DISCOUNT_VALUE'], 0, '.', ' ');?></span>
                                            </div>
