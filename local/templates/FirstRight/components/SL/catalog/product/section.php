    ...
    <div class="sort__box section">
        <ul class="sort__list">
            <?foreach ($arSort as $itemSort):
                $current_active = $itemSort['TYPE'] === $_REQUEST['sort'] && $itemSort['DIR'] === $_REQUEST['method'] || $itemSort['ACTIVE'] === 'Y' ? ' active' :  '';
                ?>
                <li class="sort__item"><a class="sort__link btn btn_sort<?=$current_active;?>" href="<?=$APPLICATION->GetCurDir().'?sort='.$itemSort['TYPE'].'&method='.$itemSort['DIR'];?>"><span class="sort__item-text"><?=$itemSort['NAME']?></span></a></li>
            <?endforeach;?>
            <?
            $arParams['ELEMENT_SORT_FIELD'] = "catalog_PRICE_1";
            $arParams['ELEMENT_SORT_ORDER'] = "asc,null";
            ?>
        </ul>
    </div>
</section>
