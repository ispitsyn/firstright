    ...
    <nav class="menu" data-search="">
        <ul class="menu__list">
            ...
            <li class="menu__item">
                ...
                <?}?>
                <div class="menu__inner-list-box section">
                    <ul class="menu__inner-list <?echo strlen($code) ? 'menu__inner-list_'.$code : '';?> section__box">
                        <?endif?>
                        <?else:?>
                                        ...
                                        case 'accessories':?>
                                            ...
                                            <?}?>
                                                    <li class="menu__accessory">
                                                        <?if ($arItem["SELECTED"]){?>
                                                            <span class="menu__accessory-link menu__accessory-link_active"><span class="menu__accessory-text"><?=$arItem["TEXT"]?></span></span>
                                                        <?} else {?>
                                                            <a href="<?=$arItem["LINK"]?>" class="menu__accessory-link"><span class="menu__accessory-text"><?=$arItem["TEXT"]?></span></a>
                                                        <?}?>
                                                    </li>
                                                    <?$accessoryNumber++;?>
                                            <?break;?>
                                        <?default:?>
                                            <li class="menu__inner-item">
                                                ...
                                                <?}?>
                                                    ...
                                                    <span class="menu__inner-link-text"><?=$arItem["TEXT"]?><?if(!empty($arItem['PARAMS']['LABEL']))echo '<i class="menu__inner-label menu__inner-label_'.$arItem['PARAMS']['LABEL']['CODE'].' new">'.$arItem['PARAMS']['LABEL']['VALUE'].'</i>'?></span>
                                                <?if ($arItem["SELECTED"]){?>
                                                    </span>
                                                <?} else {?>
                                                    </a>
