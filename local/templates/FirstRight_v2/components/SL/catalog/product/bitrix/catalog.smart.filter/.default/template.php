...
<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
                            ...
                            <div class="filter__prices">
                                <div class="filter__price-box">
                                    <input
                                            ...
                                            class="filter__price filter__price_min"/>
                                </div>
                                <div class="filter__price-separator"></div>
                                <div class="filter__price-box">
                                    <input
                                            type="text"
                                            placeholder="<?
                                            ...
                                            size="5"
                                            onkeyup="smartFilter.keyup(this)"
                                            class="filter__price filter__price_max"/>
                                </div>
                            </div>
    ...
    foreach($arResult["ITEMS"] as $key=>$arItem)
    {
        ...
        <div class="filter__group bx-filter-parameters-box bx-active">
            ...
            <div class="filter__group-box">
                <div class="filter__group-header">
                    <div class="filter__group-name"><?=$arItem["NAME"]?></div>
                </div>
                <div class="bx-filter-parameters-box-container filter__group-main" data-role="bx_filter_block">
                <?
                ...
                switch ($arItem["DISPLAY_TYPE"])
                {
                    ...
                    default://CHECKBOXES
                        ?>
                        <?foreach($arItem["VALUES"] as $val => $ar):?>
                            <div class="filter__checkbox <? echo $ar["DISABLED"] ? 'filter-property_disabled': '' ?>">
                                <div class="checkbox">
    ...
    <div class="filter__footer">
        ...
        />
        <button class="button button_theme_catalog-clear"
                type="submit"
                id="del_filter"
                name="del_filter">
